...
# ======= تنظیمات =======
TOKEN = os.getenv("TOKEN")  # حتما TOKEN را در Environment Variable ست کن
if not TOKEN:
...
async def get_depth(update: Update, context: ContextTypes.DEFAULT_TYPE):
    try:
        ...
        keyboard = [
            [InlineKeyboardButton("چسب استراکچر 881", callback_data='881')],
...
print("✅ ربات یونکس با محاسبات آماده است...")
app.run_polling()
