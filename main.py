...
if not TOKEN or len(TOKEN) < 45:
    raise ValueError("❌ TOKEN یافت نشد یا نامعتبر است. لطفاً در Render مقدار Environment Variable را بررسی کنید.")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "جهت محاسبه متریال مصرفی استفاده شده در تولید شیشه دوجداره، اطلاعات را تکمیل کنید.",
